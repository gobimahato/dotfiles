...
function M.config()
    ...
    wk.register {
        ...
        ["<leader>ll"] = {
            "<cmd>lua vim.lsp.codelens.run()<cr>", "CodeLens Action"
        },
        ["<leader>lq"] = {
            "<cmd>lua vim.diagnostic.setloclist()<cr>", "Quickfix"
        },
    ...
    local servers = {
        "lua_ls", "cssls", "html", "tsserver", "jsonls", 'pyright', "yamlls",
        "marksman", "emmet_ls", "tailwindcss", "eslint"
        -- "rust_analyzer",
    }
    ...
    for _, server in pairs(servers) do
        ...
        local require_ok, settings = pcall(require,
                                           "user.lspsettings." .. server)
        if require_ok then
