local M = {"akinsho/toggleterm.nvim", event = "VeryLazy"}
...
function M.config()
  ...
  augroup end
    ...
    function _bun_outdated() bun_outdated:toggle() end

    vim.api.nvim_set_keymap("n", "<leader>gz", "<cmd>lua _lazygit_toggle()<CR>",
                            {noremap = true, silent = true})
    vim.api.nvim_set_keymap("n", "<leader>co", "<cmd>lua _bun_outdated()<CR>",
                            {noremap = true, silent = true})
end
